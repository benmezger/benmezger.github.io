...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9fc30f521b47973dd69b66ca3e873ddc5aef08dfd3cf79ffab426d3979e5b6fc.js',function(){input.required=false;search();});}
