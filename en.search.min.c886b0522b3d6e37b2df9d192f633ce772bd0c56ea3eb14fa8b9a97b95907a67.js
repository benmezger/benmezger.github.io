...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6734ee91ecd3908692ae5ef87418d61dd4b57fd85fe5f4b12a1514e7a62456d6.js',function(){input.required=false;search();});}
