...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1c3ce1bd9e74bf95fef8b0b555204a1914872004d43f477aaaafd5ef88a4c4c2.js',function(){input.required=false;search();});}
