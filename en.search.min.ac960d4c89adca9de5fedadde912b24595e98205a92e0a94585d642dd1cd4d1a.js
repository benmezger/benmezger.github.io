...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0c7b73a73dafc966cf74f6ac0e92ef8743f593babcbf36ee90675458201b49a9.js',function(){input.required=false;search();});}
