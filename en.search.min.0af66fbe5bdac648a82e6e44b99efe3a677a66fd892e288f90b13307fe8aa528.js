...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.26c38be3703ee293333a40a575464ad285adf9eadc3112ea0509e35296006b4e.js',function(){input.required=false;search();});}
