...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.585799776cdb40c99a65c4120bf2118abf1de11db9a661fff99f9d761c90b72c.js',function(){input.required=false;search();});}
