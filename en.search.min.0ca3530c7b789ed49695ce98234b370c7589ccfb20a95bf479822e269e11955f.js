...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5cb81d3f27d5cd6513828d0a46a106c10f78c9a96e2a73ece17d573db16c460a.js',function(){input.required=false;search();});}
