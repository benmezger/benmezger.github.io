...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6e59be678282c27fa6cab448aeba052e1b50b0f7d7a337ababf7231de700e0d8.js',function(){input.required=false;search();});}
