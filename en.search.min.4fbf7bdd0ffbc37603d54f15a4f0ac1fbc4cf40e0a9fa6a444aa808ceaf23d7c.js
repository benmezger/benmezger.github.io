...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.01a39aa61761953d4fb26a76cdf0f45359da5cbaffbddb0cbcfae62de58e75c8.js',function(){input.required=false;search();});}
