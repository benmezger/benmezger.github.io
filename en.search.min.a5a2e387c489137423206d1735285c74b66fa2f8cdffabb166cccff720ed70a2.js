...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b60482a3e5f515aa44fe363d33b74230b555ae245c605c51d8aeaf6d253448a4.js',function(){input.required=false;search();});}
